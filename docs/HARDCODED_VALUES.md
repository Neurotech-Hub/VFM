...
| **3 s**       | `kPg3EventBlankMs`   | `DispenserService.h` | After a PG3 edge, suppress further PG3 event-log edges        |
...
| 3 s   | `kPg3EventBlankMs`   | Blank PG3 `AccessAttempt` / `InputChanged` edges |
